...
async function main() {
    ...
    const users = [
        { email: 'owner@demo.com', nombre: 'Administrador', rol: client_1.UserRole.owner },
        { email: 'candidato@demo.com', nombre: 'Candidato Demo', rol: client_1.UserRole.candidato },
        { email: 'coord@demo.com', nombre: 'Coordinador General', rol: client_1.UserRole.coord_general },
        { email: 'brigadista@demo.com', nombre: 'Brigadista 1', rol: client_1.UserRole.brigadista },
        { email: 'cm@demo.com', nombre: 'Community Manager', rol: client_1.UserRole.cm },
    ];
