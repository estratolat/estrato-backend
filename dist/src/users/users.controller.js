...
let UsersController = class UsersController {
    ...
    getPermisosSchema() {
        return {
            secciones: users_service_1.SECCIONES_DISPONIBLES,
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Listar usuarios del tenant' }),
...
__decorate([
    (0, common_1.Get)('permisos/schema'),
    (0, swagger_1.ApiOperation)({ summary: 'Schema de secciones y defaults por rol' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], UsersController.prototype, "getPermisosSchema", null);
__decorate([
    (0, common_1.Get)(':id'),
...
__decorate([
    (0, common_1.Post)(),
    (0, roles_guard_1.Roles)('owner', 'candidato'),
    (0, swagger_1.ApiOperation)({ summary: 'Crear usuario (solo owner/candidato)' }),
